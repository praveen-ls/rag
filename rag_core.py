...
from utils import row_to_text, parse_json, safe_exec_pandas, format_history
# -------------------- Model Loading --------------------
@st.cache_resource
def load_model():
    """Load SentenceTransformer model (cached outside Streamlit)"""
    # You can wrap caching if needed (e.g., functools.lru_cache)
